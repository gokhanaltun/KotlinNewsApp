...
class NewsRepository @Inject constructor(private val newsService: NewsService): INewsRepository {
    override suspend fun getTopHeadlines(): DataStatus<NewsResponse> {
        ...
        return if (data.isSuccessful) DataStatus.success(data.body()) else DataStatus.error("top headline Error")
    }
    ...
    override suspend fun getTopScienceHeadlines(): DataStatus<NewsResponse> {
        ...
        return if (data.isSuccessful) DataStatus.success(data.body()) else DataStatus.error("top science Error")
    }
    ...
    override suspend fun getTopSportsHeadlines(): DataStatus<NewsResponse> {
        ...
        return if (data.isSuccessful) DataStatus.success(data.body()) else DataStatus.error("to sports Error")
    }
